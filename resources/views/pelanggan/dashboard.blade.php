...
@section('content')
    <div>
        ...
        <div
            class="relative flex flex-col items-center rounded-[20px] w-full max-w-full mx-auto bg-white bg-clip-border shadow-3xl shadow-shadow-500">
            ...
            <div class="grid grid-cols-2 gap-4 w-full">
                <div
                    class="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border py-4 shadow-3xl shadow-shadow-500  ">
                ...
                <div
                    class="flex flex-col justify-center rounded-2xl bg-white bg-clip-border py-4 shadow-3xl shadow-shadow-500  ">
