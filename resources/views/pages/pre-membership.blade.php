...
@section('content')
    <div class="flex items-center justify-center p-12 ">
        <div class="flex flex-col shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] p-10">
            <div class="mx-auto w-full ">
                <div class="flex justify-center mb-8">
                    <img src="{{ asset('images/kartupas.png') }}" alt="Logo" class="">
                </div>
                <div class="flex flex-col justify-center">
                    <h1 class="text-2xl uppercase font-semibold text-center text-gray-800 mt-8 mb-6">apa itu kartu member
                        pas?
                    </h1>
                    <p class="text-md text-lg font-medium text-gray-600">Kartu Member PAS atau Kartu Member Pelanggan
                        Assalaam
                        Hypermarket, adalah kartu member khusus untuk pelanggan Assalaam Hypermarket yang bisa digunakan
                        untuk
                        berbelanja dengan beberapa benefit yang bisa didapatkan.
                    </p>
                    <h1 class="text-2xl uppercase font-semibold text-center text-gray-800 mt-8 mb-6">KEUNTUNGAN BAGI
                        CUSTOMER
                        DENGAN
                        KARTU MEMBER PAS
                    </h1>
                    <p class="text-md text-lg font-medium text-gray-600">Customer apabila berbelanja menggunakan Kartu PAS
                        akan
                    ...
                    <p class="text-center text-md text-lg font-medium text-gray-600">Pelanggan Klik Saja Tombol Daftar
                        Dibawah
                        ini
