            ...
            <div class="flex flex-col justify-center">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-md text-lg font-medium text-gray-600">Assalaam Hypermarket merupakan salah satu unit
                        bisnis usaha PT. Tiga Serangkai Group yang bergerak di bidang retail, mulai beroperasi pada tanggal
                        15 November 2001, di lokasi yang sangat strategis yakni perlintasan Solo – Yogyakarta – Semarang,
                        tepatnya di Jalan Ahmad Yani No. 308 Pabelan, Kartasura, Sukoharjo.
                        Awal berdiri Assalaam Hypermarket merupakan perusahaan retail franchise Goro Batara Sakti dengan
                        nama Goro Assalaam. Tahun 2007 setelah franchise berakhir berubah nama menjadi ASSALAAM HYPERMARKET.
                        Assalaam Hypermarket adalah retail muslim terbesar di area Solo Raya dan sekitarnya dengan luas area
                        kurang lebih sekitar 69.797 m² dan luas bangunan toko 11.673 m² .
                        Untuk memenuhi kebutuhaan masyarakat, saat ini Assalaam Hypermarket telah bekerjasama dengan lebih
                        dari 250 supplier baik lokal maupun nasional dan 200 tenant yang berada di area Assalaam
                        Hypermarket.
                        Selain memenuhi kebutuhan masyarakat dengan layanan prima serta produk lengkap dan halal, Assalaam
                        Hypermarket juga memiliki fasilitas lengkap diantaranya:
                    </p>
                    <ul class="list-disc px-10 pt-5">
                        <li>Masjid Besar Ibaadurrahmaan
                        </li>
                        <li>Parkir luas dan nyaman
                        </li>
                        <li>Arena bermain anak
                        </li>
                        <li>Arena berkuda luar ruangan
                        </li>
                        <li>Food Court (area toko & luar area toko)
                        </li>
                        <li>Shelter jajanan
                        </li>
                        <li>ATM
